module.exports = function(grunt) {
  ...
  var jsProdFileList = [
    ...
    //'assets/js/custom/toc.js',
    //'assets/js/custom/map-control.js'
  ...
  shell: {
    ...
    rsyncStaging: {
      command: 'rsync --progress -a -v -rz --checksum --delete -e "ssh -p 1234" _site/ username@XXX.XXX.XXX.XXX:/var/www/test.com/public_html/project'
    },
